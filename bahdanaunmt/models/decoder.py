...
class Decoder(nn.Module):
    ...
    def __init__(self, hidden_size, output_size, dropout_p=0.1, device='cuda', max_s_len=20) -> None:
        """Implementation of a basic RNN decoder with additive attention and GRU cells.
        ...
        Args:
            ...
            max_s_len (int) = 15: Maximum sentence length.
        """
    ...
    def forward(self, encoder_outputs, encoder_hidden, target_tensor=None):
        ...
        decoder_input = torch.empty(batch_size, 1, dtype=torch.long, device=self.device).fill_(1) 
